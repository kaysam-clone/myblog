...
urlpatterns = [
    ...
    path('custom-admin-category/<int:pk>/update', category_update, name ='category_update'),
    path('custom-admin-category/<int:pk>/delete', category_delete, name ='category_delete'),
